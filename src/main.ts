...
univer.createUnit(UniverInstanceType.UNIVER_SHEET, {
    ...
    sheets: {
        ...
        cellData: {
            0: {
                1: { v: "Try to Cut and paste me I will lose my value", s: "style_id_1" },
            },
            1: {
                0: { v: "Date can't be changed even if it fits the condition if the default value of the cell is null", s: "style_id_1" }
            }
        },
    ...
    resources: [
        ...
        data: JSON.stringify({"Passagers_sheet":
            [
            {
                uid:"qTsxc-6",
                type:"date",
                ...
                ranges:[{startRow:1,startColumn:1,endRow:1,endColumn:1,rangeType:0}],
                allowBlank:false,
                errorStyle: 1,
                error: "Invalid !",
        ...
        },
        {
            ...
            data: JSON.stringify({
            "Passagers_sheet":[
                {name:"Protection(cellules à ne pas toucher)", unitId:"Passagers_worksheet",subUnitId:"Passagers_sheet",permissionId:"zfhyvc141ujte",unitType:3,id:"TrB1",ranges: [{startRow:0,startColumn:1,endRow:0,endColumn:1,rangeType:0}],description:"Ne pas toucher !"},
            ]
            }),
        }
    ]
